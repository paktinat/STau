...
process.readAK5PFchs = process.readAK5PF.clone(payloadName = 'AK5PFchs') # JEC for AK5 pf with PFnoPU
process.p = cms.Path(process.readAK5PF * process.readAK5Calo * process.readAK5PFchs )
