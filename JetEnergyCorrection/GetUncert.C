...
void GetUncert(){
	...
	cout << JESUncertainty(50, 0) << endl;
	
}

double JESUncertainty(double pt, double eta){
...
//  FactorizedJetCorrector *JetCor = new FactorizedJetCorrector(JetCorPar);
  //----------- Uncertainty Object -----------------------------
  JetCorrectionUncertainty *jecUnc = new JetCorrectionUncertainty("Fall10_AK5Calo_Uncertainty.txt");
