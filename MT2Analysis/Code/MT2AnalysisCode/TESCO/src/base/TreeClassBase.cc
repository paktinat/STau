...
const bool TreeClassBase::GetAllByLabel(void) {
    ...
    result &= event->getByLabel( tTauCombinedIsolationDeltaBetaCorrRaw, hTauCombinedIsolationDeltaBetaCorrRaw );
    if ( hTauCombinedIsolationDeltaBetaCorrRaw.isValid() ) TauCombinedIsolationDeltaBetaCorrRaw = *hTauCombinedIsolationDeltaBetaCorrRaw;
    result &= event->getByLabel( tTauDeadECALElectronRejection, hTauDeadECALElectronRejection );
    if ( hTauDeadECALElectronRejection.isValid() ) TauDeadECALElectronRejection = *hTauDeadECALElectronRejection;
    ...
    result &= event->getByLabel( tTauLooseCombinedIsolationDeltaBetaCorr, hTauLooseCombinedIsolationDeltaBetaCorr );
    if ( hTauLooseCombinedIsolationDeltaBetaCorr.isValid() ) TauLooseCombinedIsolationDeltaBetaCorr = *hTauLooseCombinedIsolationDeltaBetaCorr;
    result &= event->getByLabel( tTauLooseCombinedIsolationDeltaBetaCorr3Hits, hTauLooseCombinedIsolationDeltaBetaCorr3Hits );
    if ( hTauLooseCombinedIsolationDeltaBetaCorr3Hits.isValid() ) TauLooseCombinedIsolationDeltaBetaCorr3Hits = *hTauLooseCombinedIsolationDeltaBetaCorr3Hits;
    ...
    result &= event->getByLabel( tTauMediumCombinedIsolationDeltaBetaCorr, hTauMediumCombinedIsolationDeltaBetaCorr );
    if ( hTauMediumCombinedIsolationDeltaBetaCorr.isValid() ) TauMediumCombinedIsolationDeltaBetaCorr = *hTauMediumCombinedIsolationDeltaBetaCorr;
    result &= event->getByLabel( tTauMediumCombinedIsolationDeltaBetaCorr3Hits, hTauMediumCombinedIsolationDeltaBetaCorr3Hits );
    if ( hTauMediumCombinedIsolationDeltaBetaCorr3Hits.isValid() ) TauMediumCombinedIsolationDeltaBetaCorr3Hits = *hTauMediumCombinedIsolationDeltaBetaCorr3Hits;
    ...
    result &= event->getByLabel( tTauRawCombinedIsolationDBSumPtCorr3Hits, hTauRawCombinedIsolationDBSumPtCorr3Hits );
    if ( hTauRawCombinedIsolationDBSumPtCorr3Hits.isValid() ) TauRawCombinedIsolationDBSumPtCorr3Hits = *hTauRawCombinedIsolationDBSumPtCorr3Hits;
    ...
    result &= event->getByLabel( tTauTightCombinedIsolationDeltaBetaCorr, hTauTightCombinedIsolationDeltaBetaCorr );
    if ( hTauTightCombinedIsolationDeltaBetaCorr.isValid() ) TauTightCombinedIsolationDeltaBetaCorr = *hTauTightCombinedIsolationDeltaBetaCorr;
    result &= event->getByLabel( tTauTightCombinedIsolationDeltaBetaCorr3Hits, hTauTightCombinedIsolationDeltaBetaCorr3Hits );
    if ( hTauTightCombinedIsolationDeltaBetaCorr3Hits.isValid() ) TauTightCombinedIsolationDeltaBetaCorr3Hits = *hTauTightCombinedIsolationDeltaBetaCorr3Hits;
    ...
    result &= event->getByLabel( tTauVLooseCombinedIsolationDeltaBetaCorr, hTauVLooseCombinedIsolationDeltaBetaCorr );
    if ( hTauVLooseCombinedIsolationDeltaBetaCorr.isValid() ) TauVLooseCombinedIsolationDeltaBetaCorr = *hTauVLooseCombinedIsolationDeltaBetaCorr;
    ...
    result &= event->getByLabel( tTaucategoryMVA3ElectronRejection, hTaucategoryMVA3ElectronRejection );
    if ( hTaucategoryMVA3ElectronRejection.isValid() ) TaucategoryMVA3ElectronRejection = *hTaucategoryMVA3ElectronRejection;
    result &= event->getByLabel( tTaurawMVA3ElectronRejection, hTaurawMVA3ElectronRejection );
    if ( hTaurawMVA3ElectronRejection.isValid() ) TaurawMVA3ElectronRejection = *hTaurawMVA3ElectronRejection;
...
void TreeClassBase::Init(void)
{
    ...
    tTauCombinedIsolationDeltaBetaCorrRaw = edm::InputTag("analyze","TauCombinedIsolationDeltaBetaCorrRaw");
    tTauDeadECALElectronRejection = edm::InputTag("analyze","TauDeadECALElectronRejection");
    ...
    tTauLooseCombinedIsolationDeltaBetaCorr = edm::InputTag("analyze","TauLooseCombinedIsolationDeltaBetaCorr");
    tTauLooseCombinedIsolationDeltaBetaCorr3Hits = edm::InputTag("analyze","TauLooseCombinedIsolationDeltaBetaCorr3Hits");
    ...
    tTauMediumCombinedIsolationDeltaBetaCorr = edm::InputTag("analyze","TauMediumCombinedIsolationDeltaBetaCorr");
    tTauMediumCombinedIsolationDeltaBetaCorr3Hits = edm::InputTag("analyze","TauMediumCombinedIsolationDeltaBetaCorr3Hits");
    ...
    tTauRawCombinedIsolationDBSumPtCorr3Hits = edm::InputTag("analyze","TauRawCombinedIsolationDBSumPtCorr3Hits");
    ...
    tTauTightCombinedIsolationDeltaBetaCorr = edm::InputTag("analyze","TauTightCombinedIsolationDeltaBetaCorr");
    tTauTightCombinedIsolationDeltaBetaCorr3Hits = edm::InputTag("analyze","TauTightCombinedIsolationDeltaBetaCorr3Hits");
    ...
    tTauVLooseCombinedIsolationDeltaBetaCorr = edm::InputTag("analyze","TauVLooseCombinedIsolationDeltaBetaCorr");
    ...
    tTaucategoryMVA3ElectronRejection = edm::InputTag("analyze","TaucategoryMVA3ElectronRejection");
    tTaurawMVA3ElectronRejection = edm::InputTag("analyze","TaurawMVA3ElectronRejection");
