...
const bool TreeClassBase::GetAllByLabel(void) {
    ...
    if ( fCurRun != event->id().run() ) {
      ...
      result &= run.getByLabel( tMaxPfCandEta, hMaxPfCandEta );
      if ( hMaxPfCandEta.isValid() ) MaxPfCandEta = *hMaxPfCandEta;
      ...
      result &= run.getByLabel( tMinSCrawPt, hMinSCrawPt );
      if ( hMinSCrawPt.isValid() ) MinSCrawPt = *hMinSCrawPt;
    ...
    result &= event->getByLabel( tJBeta, hJBeta );
    if ( hJBeta.isValid() ) JBeta = *hJBeta;
    result &= event->getByLabel( tJBetaSq, hJBetaSq );
    if ( hJBetaSq.isValid() ) JBetaSq = *hJBetaSq;
    ...
    result &= event->getByLabel( tJPassPileupIDL0, hJPassPileupIDL0 );
    if ( hJPassPileupIDL0.isValid() ) JPassPileupIDL0 = *hJPassPileupIDL0;
    result &= event->getByLabel( tJPassPileupIDL1, hJPassPileupIDL1 );
    if ( hJPassPileupIDL1.isValid() ) JPassPileupIDL1 = *hJPassPileupIDL1;
    result &= event->getByLabel( tJPassPileupIDL2, hJPassPileupIDL2 );
    if ( hJPassPileupIDL2.isValid() ) JPassPileupIDL2 = *hJPassPileupIDL2;
    result &= event->getByLabel( tJPassPileupIDL3, hJPassPileupIDL3 );
    if ( hJPassPileupIDL3.isValid() ) JPassPileupIDL3 = *hJPassPileupIDL3;
    result &= event->getByLabel( tJPassPileupIDL4, hJPassPileupIDL4 );
    if ( hJPassPileupIDL4.isValid() ) JPassPileupIDL4 = *hJPassPileupIDL4;
    result &= event->getByLabel( tJPassPileupIDM0, hJPassPileupIDM0 );
    if ( hJPassPileupIDM0.isValid() ) JPassPileupIDM0 = *hJPassPileupIDM0;
    result &= event->getByLabel( tJPassPileupIDM1, hJPassPileupIDM1 );
    if ( hJPassPileupIDM1.isValid() ) JPassPileupIDM1 = *hJPassPileupIDM1;
    result &= event->getByLabel( tJPassPileupIDM2, hJPassPileupIDM2 );
    if ( hJPassPileupIDM2.isValid() ) JPassPileupIDM2 = *hJPassPileupIDM2;
    result &= event->getByLabel( tJPassPileupIDM3, hJPassPileupIDM3 );
    if ( hJPassPileupIDM3.isValid() ) JPassPileupIDM3 = *hJPassPileupIDM3;
    result &= event->getByLabel( tJPassPileupIDM4, hJPassPileupIDM4 );
    if ( hJPassPileupIDM4.isValid() ) JPassPileupIDM4 = *hJPassPileupIDM4;
    result &= event->getByLabel( tJPassPileupIDT0, hJPassPileupIDT0 );
    if ( hJPassPileupIDT0.isValid() ) JPassPileupIDT0 = *hJPassPileupIDT0;
    result &= event->getByLabel( tJPassPileupIDT1, hJPassPileupIDT1 );
    if ( hJPassPileupIDT1.isValid() ) JPassPileupIDT1 = *hJPassPileupIDT1;
    result &= event->getByLabel( tJPassPileupIDT2, hJPassPileupIDT2 );
    if ( hJPassPileupIDT2.isValid() ) JPassPileupIDT2 = *hJPassPileupIDT2;
    result &= event->getByLabel( tJPassPileupIDT3, hJPassPileupIDT3 );
    if ( hJPassPileupIDT3.isValid() ) JPassPileupIDT3 = *hJPassPileupIDT3;
    result &= event->getByLabel( tJPassPileupIDT4, hJPassPileupIDT4 );
    if ( hJPassPileupIDT4.isValid() ) JPassPileupIDT4 = *hJPassPileupIDT4;
    ...
    result &= event->getByLabel( tJQGTagLD, hJQGTagLD );
    if ( hJQGTagLD.isValid() ) JQGTagLD = *hJQGTagLD;
    result &= event->getByLabel( tJQGTagMLP, hJQGTagMLP );
    if ( hJQGTagMLP.isValid() ) JQGTagMLP = *hJQGTagMLP;
    result &= event->getByLabel( tJRMSCand, hJRMSCand );
    if ( hJRMSCand.isValid() ) JRMSCand = *hJRMSCand;
    result &= event->getByLabel( tJSmearedQGL, hJSmearedQGL );
    if ( hJSmearedQGL.isValid() ) JSmearedQGL = *hJSmearedQGL;
    result &= event->getByLabel( tJVrtxListStart, hJVrtxListStart );
    if ( hJVrtxListStart.isValid() ) JVrtxListStart = *hJVrtxListStart;
    ...
    result &= event->getByLabel( tPfCandBelongsToJet, hPfCandBelongsToJet );
    if ( hPfCandBelongsToJet.isValid() ) PfCandBelongsToJet = *hPfCandBelongsToJet;
    result &= event->getByLabel( tPfCandEcalEnergy, hPfCandEcalEnergy );
    if ( hPfCandEcalEnergy.isValid() ) PfCandEcalEnergy = *hPfCandEcalEnergy;
    ...
    result &= event->getByLabel( tPhoCiCPFIsoChargedDR03, hPhoCiCPFIsoChargedDR03 );
    if ( hPhoCiCPFIsoChargedDR03.isValid() ) PhoCiCPFIsoChargedDR03 = *hPhoCiCPFIsoChargedDR03;
    result &= event->getByLabel( tPhoCiCPFIsoChargedDR04, hPhoCiCPFIsoChargedDR04 );
    if ( hPhoCiCPFIsoChargedDR04.isValid() ) PhoCiCPFIsoChargedDR04 = *hPhoCiCPFIsoChargedDR04;
    result &= event->getByLabel( tPhoCiCPFIsoNeutralDR03, hPhoCiCPFIsoNeutralDR03 );
    if ( hPhoCiCPFIsoNeutralDR03.isValid() ) PhoCiCPFIsoNeutralDR03 = *hPhoCiCPFIsoNeutralDR03;
    result &= event->getByLabel( tPhoCiCPFIsoNeutralDR04, hPhoCiCPFIsoNeutralDR04 );
    if ( hPhoCiCPFIsoNeutralDR04.isValid() ) PhoCiCPFIsoNeutralDR04 = *hPhoCiCPFIsoNeutralDR04;
    result &= event->getByLabel( tPhoCiCPFIsoPhotonDR03, hPhoCiCPFIsoPhotonDR03 );
    if ( hPhoCiCPFIsoPhotonDR03.isValid() ) PhoCiCPFIsoPhotonDR03 = *hPhoCiCPFIsoPhotonDR03;
    result &= event->getByLabel( tPhoCiCPFIsoPhotonDR04, hPhoCiCPFIsoPhotonDR04 );
    if ( hPhoCiCPFIsoPhotonDR04.isValid() ) PhoCiCPFIsoPhotonDR04 = *hPhoCiCPFIsoPhotonDR04;
    ...
    result &= event->getByLabel( tPhoFootprintPfCands, hPhoFootprintPfCands );
    if ( hPhoFootprintPfCands.isValid() ) PhoFootprintPfCands = *hPhoFootprintPfCands;
    result &= event->getByLabel( tPhoFootprintPfCandsListStart, hPhoFootprintPfCandsListStart );
    if ( hPhoFootprintPfCandsListStart.isValid() ) PhoFootprintPfCandsListStart = *hPhoFootprintPfCandsListStart;
    ...
    result &= event->getByLabel( tPhoIDMVA, hPhoIDMVA );
    if ( hPhoIDMVA.isValid() ) PhoIDMVA = *hPhoIDMVA;
    ...
    result &= event->getByLabel( tPhoLambdaRatio, hPhoLambdaRatio );
    if ( hPhoLambdaRatio.isValid() ) PhoLambdaRatio = *hPhoLambdaRatio;
    ...
    result &= event->getByLabel( tPhoMatchedPFPhotonOrElectronCand, hPhoMatchedPFPhotonOrElectronCand );
    if ( hPhoMatchedPFPhotonOrElectronCand.isValid() ) PhoMatchedPFPhotonOrElectronCand = *hPhoMatchedPFPhotonOrElectronCand;
    ...
    result &= event->getByLabel( tPhoRegrEnergy, hPhoRegrEnergy );
    if ( hPhoRegrEnergy.isValid() ) PhoRegrEnergy = *hPhoRegrEnergy;
    result &= event->getByLabel( tPhoRegrEnergyErr, hPhoRegrEnergyErr );
    if ( hPhoRegrEnergyErr.isValid() ) PhoRegrEnergyErr = *hPhoRegrEnergyErr;
    result &= event->getByLabel( tPhoS4OverS1, hPhoS4OverS1 );
    if ( hPhoS4OverS1.isValid() ) PhoS4OverS1 = *hPhoS4OverS1;
    result &= event->getByLabel( tPhoS4Ratio, hPhoS4Ratio );
    if ( hPhoS4Ratio.isValid() ) PhoS4Ratio = *hPhoS4Ratio;
    result &= event->getByLabel( tPhoSCEta, hPhoSCEta );
    if ( hPhoSCEta.isValid() ) PhoSCEta = *hPhoSCEta;
    result &= event->getByLabel( tPhoSCEtaWidth, hPhoSCEtaWidth );
    if ( hPhoSCEtaWidth.isValid() ) PhoSCEtaWidth = *hPhoSCEtaWidth;
    result &= event->getByLabel( tPhoSCPhiWidth, hPhoSCPhiWidth );
    if ( hPhoSCPhiWidth.isValid() ) PhoSCPhiWidth = *hPhoSCPhiWidth;
    ...
    result &= event->getByLabel( tPhoSCRemovalPFIsoChargedPrimVtx, hPhoSCRemovalPFIsoChargedPrimVtx );
    if ( hPhoSCRemovalPFIsoChargedPrimVtx.isValid() ) PhoSCRemovalPFIsoChargedPrimVtx = *hPhoSCRemovalPFIsoChargedPrimVtx;
    result &= event->getByLabel( tPhoSCRemovalPFIsoChargedPrimVtxRCone, hPhoSCRemovalPFIsoChargedPrimVtxRCone );
    if ( hPhoSCRemovalPFIsoChargedPrimVtxRCone.isValid() ) PhoSCRemovalPFIsoChargedPrimVtxRCone = *hPhoSCRemovalPFIsoChargedPrimVtxRCone;
    result &= event->getByLabel( tPhoSCRemovalPFIsoChargedRCone, hPhoSCRemovalPFIsoChargedRCone );
    if ( hPhoSCRemovalPFIsoChargedRCone.isValid() ) PhoSCRemovalPFIsoChargedRCone = *hPhoSCRemovalPFIsoChargedRCone;
    ...
    result &= event->getByLabel( tPhoSCRemovalPFIsoNeutralRCone, hPhoSCRemovalPFIsoNeutralRCone );
    if ( hPhoSCRemovalPFIsoNeutralRCone.isValid() ) PhoSCRemovalPFIsoNeutralRCone = *hPhoSCRemovalPFIsoNeutralRCone;
    ...
    result &= event->getByLabel( tPhoSCRemovalPFIsoPhotonRCone, hPhoSCRemovalPFIsoPhotonRCone );
    if ( hPhoSCRemovalPFIsoPhotonRCone.isValid() ) PhoSCRemovalPFIsoPhotonRCone = *hPhoSCRemovalPFIsoPhotonRCone;
    result &= event->getByLabel( tPhoSCRemovalRConeEta, hPhoSCRemovalRConeEta );
    if ( hPhoSCRemovalRConeEta.isValid() ) PhoSCRemovalRConeEta = *hPhoSCRemovalRConeEta;
    result &= event->getByLabel( tPhoSCRemovalRConePhi, hPhoSCRemovalRConePhi );
    if ( hPhoSCRemovalRConePhi.isValid() ) PhoSCRemovalRConePhi = *hPhoSCRemovalRConePhi;
    ...
    result &= event->getByLabel( tPhoSigmaIetaIphi, hPhoSigmaIetaIphi );
    if ( hPhoSigmaIetaIphi.isValid() ) PhoSigmaIetaIphi = *hPhoSigmaIetaIphi;
    result &= event->getByLabel( tPhoSigmaIphiIphi, hPhoSigmaIphiIphi );
    if ( hPhoSigmaIphiIphi.isValid() ) PhoSigmaIphiIphi = *hPhoSigmaIphiIphi;
    result &= event->getByLabel( tPhoSigmaRR, hPhoSigmaRR );
    if ( hPhoSigmaRR.isValid() ) PhoSigmaRR = *hPhoSigmaRR;
    result &= event->getByLabel( tPhoVrtxListStart, hPhoVrtxListStart );
    if ( hPhoVrtxListStart.isValid() ) PhoVrtxListStart = *hPhoVrtxListStart;
    ...
    result &= event->getByLabel( tTauagainstElectronDeadECAL, hTauagainstElectronDeadECAL );
    if ( hTauagainstElectronDeadECAL.isValid() ) TauagainstElectronDeadECAL = *hTauagainstElectronDeadECAL;
    result &= event->getByLabel( tTauagainstElectronLoose, hTauagainstElectronLoose );
    if ( hTauagainstElectronLoose.isValid() ) TauagainstElectronLoose = *hTauagainstElectronLoose;
    result &= event->getByLabel( tTauagainstElectronLooseMVA5, hTauagainstElectronLooseMVA5 );
    if ( hTauagainstElectronLooseMVA5.isValid() ) TauagainstElectronLooseMVA5 = *hTauagainstElectronLooseMVA5;
    result &= event->getByLabel( tTauagainstElectronMVA5category, hTauagainstElectronMVA5category );
    if ( hTauagainstElectronMVA5category.isValid() ) TauagainstElectronMVA5category = *hTauagainstElectronMVA5category;
    result &= event->getByLabel( tTauagainstElectronMVA5raw, hTauagainstElectronMVA5raw );
    if ( hTauagainstElectronMVA5raw.isValid() ) TauagainstElectronMVA5raw = *hTauagainstElectronMVA5raw;
    result &= event->getByLabel( tTauagainstElectronMedium, hTauagainstElectronMedium );
    if ( hTauagainstElectronMedium.isValid() ) TauagainstElectronMedium = *hTauagainstElectronMedium;
    result &= event->getByLabel( tTauagainstElectronMediumMVA5, hTauagainstElectronMediumMVA5 );
    if ( hTauagainstElectronMediumMVA5.isValid() ) TauagainstElectronMediumMVA5 = *hTauagainstElectronMediumMVA5;
    result &= event->getByLabel( tTauagainstElectronTight, hTauagainstElectronTight );
    if ( hTauagainstElectronTight.isValid() ) TauagainstElectronTight = *hTauagainstElectronTight;
    result &= event->getByLabel( tTauagainstElectronTightMVA5, hTauagainstElectronTightMVA5 );
    if ( hTauagainstElectronTightMVA5.isValid() ) TauagainstElectronTightMVA5 = *hTauagainstElectronTightMVA5;
    result &= event->getByLabel( tTauagainstElectronVLooseMVA5, hTauagainstElectronVLooseMVA5 );
    if ( hTauagainstElectronVLooseMVA5.isValid() ) TauagainstElectronVLooseMVA5 = *hTauagainstElectronVLooseMVA5;
    result &= event->getByLabel( tTauagainstElectronVTightMVA5, hTauagainstElectronVTightMVA5 );
    if ( hTauagainstElectronVTightMVA5.isValid() ) TauagainstElectronVTightMVA5 = *hTauagainstElectronVTightMVA5;
    result &= event->getByLabel( tTauagainstMuonLoose, hTauagainstMuonLoose );
    if ( hTauagainstMuonLoose.isValid() ) TauagainstMuonLoose = *hTauagainstMuonLoose;
    result &= event->getByLabel( tTauagainstMuonLoose2, hTauagainstMuonLoose2 );
    if ( hTauagainstMuonLoose2.isValid() ) TauagainstMuonLoose2 = *hTauagainstMuonLoose2;
    result &= event->getByLabel( tTauagainstMuonLoose3, hTauagainstMuonLoose3 );
    if ( hTauagainstMuonLoose3.isValid() ) TauagainstMuonLoose3 = *hTauagainstMuonLoose3;
    result &= event->getByLabel( tTauagainstMuonLooseMVA, hTauagainstMuonLooseMVA );
    if ( hTauagainstMuonLooseMVA.isValid() ) TauagainstMuonLooseMVA = *hTauagainstMuonLooseMVA;
    result &= event->getByLabel( tTauagainstMuonMVAraw, hTauagainstMuonMVAraw );
    if ( hTauagainstMuonMVAraw.isValid() ) TauagainstMuonMVAraw = *hTauagainstMuonMVAraw;
    result &= event->getByLabel( tTauagainstMuonMedium, hTauagainstMuonMedium );
    if ( hTauagainstMuonMedium.isValid() ) TauagainstMuonMedium = *hTauagainstMuonMedium;
    result &= event->getByLabel( tTauagainstMuonMedium2, hTauagainstMuonMedium2 );
    if ( hTauagainstMuonMedium2.isValid() ) TauagainstMuonMedium2 = *hTauagainstMuonMedium2;
    result &= event->getByLabel( tTauagainstMuonMediumMVA, hTauagainstMuonMediumMVA );
    if ( hTauagainstMuonMediumMVA.isValid() ) TauagainstMuonMediumMVA = *hTauagainstMuonMediumMVA;
    result &= event->getByLabel( tTauagainstMuonTight, hTauagainstMuonTight );
    if ( hTauagainstMuonTight.isValid() ) TauagainstMuonTight = *hTauagainstMuonTight;
    result &= event->getByLabel( tTauagainstMuonTight2, hTauagainstMuonTight2 );
    if ( hTauagainstMuonTight2.isValid() ) TauagainstMuonTight2 = *hTauagainstMuonTight2;
    result &= event->getByLabel( tTauagainstMuonTight3, hTauagainstMuonTight3 );
    if ( hTauagainstMuonTight3.isValid() ) TauagainstMuonTight3 = *hTauagainstMuonTight3;
    result &= event->getByLabel( tTauagainstMuonTightMVA, hTauagainstMuonTightMVA );
    if ( hTauagainstMuonTightMVA.isValid() ) TauagainstMuonTightMVA = *hTauagainstMuonTightMVA;
    result &= event->getByLabel( tTaubyCombinedIsolationDeltaBetaCorrRaw, hTaubyCombinedIsolationDeltaBetaCorrRaw );
    if ( hTaubyCombinedIsolationDeltaBetaCorrRaw.isValid() ) TaubyCombinedIsolationDeltaBetaCorrRaw = *hTaubyCombinedIsolationDeltaBetaCorrRaw;
    result &= event->getByLabel( tTaubyCombinedIsolationDeltaBetaCorrRaw3Hits, hTaubyCombinedIsolationDeltaBetaCorrRaw3Hits );
    if ( hTaubyCombinedIsolationDeltaBetaCorrRaw3Hits.isValid() ) TaubyCombinedIsolationDeltaBetaCorrRaw3Hits = *hTaubyCombinedIsolationDeltaBetaCorrRaw3Hits;
    result &= event->getByLabel( tTaubyIsolationMVA3newDMwLTraw, hTaubyIsolationMVA3newDMwLTraw );
    if ( hTaubyIsolationMVA3newDMwLTraw.isValid() ) TaubyIsolationMVA3newDMwLTraw = *hTaubyIsolationMVA3newDMwLTraw;
    result &= event->getByLabel( tTaubyIsolationMVA3newDMwoLTraw, hTaubyIsolationMVA3newDMwoLTraw );
    if ( hTaubyIsolationMVA3newDMwoLTraw.isValid() ) TaubyIsolationMVA3newDMwoLTraw = *hTaubyIsolationMVA3newDMwoLTraw;
    result &= event->getByLabel( tTaubyIsolationMVA3oldDMwLTraw, hTaubyIsolationMVA3oldDMwLTraw );
    if ( hTaubyIsolationMVA3oldDMwLTraw.isValid() ) TaubyIsolationMVA3oldDMwLTraw = *hTaubyIsolationMVA3oldDMwLTraw;
    result &= event->getByLabel( tTaubyIsolationMVA3oldDMwoLTraw, hTaubyIsolationMVA3oldDMwoLTraw );
    if ( hTaubyIsolationMVA3oldDMwoLTraw.isValid() ) TaubyIsolationMVA3oldDMwoLTraw = *hTaubyIsolationMVA3oldDMwoLTraw;
    result &= event->getByLabel( tTaubyLooseCombinedIsolationDeltaBetaCorr, hTaubyLooseCombinedIsolationDeltaBetaCorr );
    if ( hTaubyLooseCombinedIsolationDeltaBetaCorr.isValid() ) TaubyLooseCombinedIsolationDeltaBetaCorr = *hTaubyLooseCombinedIsolationDeltaBetaCorr;
    result &= event->getByLabel( tTaubyLooseCombinedIsolationDeltaBetaCorr3Hits, hTaubyLooseCombinedIsolationDeltaBetaCorr3Hits );
    if ( hTaubyLooseCombinedIsolationDeltaBetaCorr3Hits.isValid() ) TaubyLooseCombinedIsolationDeltaBetaCorr3Hits = *hTaubyLooseCombinedIsolationDeltaBetaCorr3Hits;
    result &= event->getByLabel( tTaubyLooseIsolation, hTaubyLooseIsolation );
    if ( hTaubyLooseIsolation.isValid() ) TaubyLooseIsolation = *hTaubyLooseIsolation;
    result &= event->getByLabel( tTaubyLooseIsolationMVA3newDMwLT, hTaubyLooseIsolationMVA3newDMwLT );
    if ( hTaubyLooseIsolationMVA3newDMwLT.isValid() ) TaubyLooseIsolationMVA3newDMwLT = *hTaubyLooseIsolationMVA3newDMwLT;
    result &= event->getByLabel( tTaubyLooseIsolationMVA3newDMwoLT, hTaubyLooseIsolationMVA3newDMwoLT );
    if ( hTaubyLooseIsolationMVA3newDMwoLT.isValid() ) TaubyLooseIsolationMVA3newDMwoLT = *hTaubyLooseIsolationMVA3newDMwoLT;
    result &= event->getByLabel( tTaubyLooseIsolationMVA3oldDMwLT, hTaubyLooseIsolationMVA3oldDMwLT );
    if ( hTaubyLooseIsolationMVA3oldDMwLT.isValid() ) TaubyLooseIsolationMVA3oldDMwLT = *hTaubyLooseIsolationMVA3oldDMwLT;
    result &= event->getByLabel( tTaubyLooseIsolationMVA3oldDMwoLT, hTaubyLooseIsolationMVA3oldDMwoLT );
    if ( hTaubyLooseIsolationMVA3oldDMwoLT.isValid() ) TaubyLooseIsolationMVA3oldDMwoLT = *hTaubyLooseIsolationMVA3oldDMwoLT;
    result &= event->getByLabel( tTaubyMediumCombinedIsolationDeltaBetaCorr, hTaubyMediumCombinedIsolationDeltaBetaCorr );
    if ( hTaubyMediumCombinedIsolationDeltaBetaCorr.isValid() ) TaubyMediumCombinedIsolationDeltaBetaCorr = *hTaubyMediumCombinedIsolationDeltaBetaCorr;
    result &= event->getByLabel( tTaubyMediumCombinedIsolationDeltaBetaCorr3Hits, hTaubyMediumCombinedIsolationDeltaBetaCorr3Hits );
    if ( hTaubyMediumCombinedIsolationDeltaBetaCorr3Hits.isValid() ) TaubyMediumCombinedIsolationDeltaBetaCorr3Hits = *hTaubyMediumCombinedIsolationDeltaBetaCorr3Hits;
    result &= event->getByLabel( tTaubyMediumIsolationMVA3newDMwLT, hTaubyMediumIsolationMVA3newDMwLT );
    if ( hTaubyMediumIsolationMVA3newDMwLT.isValid() ) TaubyMediumIsolationMVA3newDMwLT = *hTaubyMediumIsolationMVA3newDMwLT;
    result &= event->getByLabel( tTaubyMediumIsolationMVA3newDMwoLT, hTaubyMediumIsolationMVA3newDMwoLT );
    if ( hTaubyMediumIsolationMVA3newDMwoLT.isValid() ) TaubyMediumIsolationMVA3newDMwoLT = *hTaubyMediumIsolationMVA3newDMwoLT;
    result &= event->getByLabel( tTaubyMediumIsolationMVA3oldDMwLT, hTaubyMediumIsolationMVA3oldDMwLT );
    if ( hTaubyMediumIsolationMVA3oldDMwLT.isValid() ) TaubyMediumIsolationMVA3oldDMwLT = *hTaubyMediumIsolationMVA3oldDMwLT;
    result &= event->getByLabel( tTaubyMediumIsolationMVA3oldDMwoLT, hTaubyMediumIsolationMVA3oldDMwoLT );
    if ( hTaubyMediumIsolationMVA3oldDMwoLT.isValid() ) TaubyMediumIsolationMVA3oldDMwoLT = *hTaubyMediumIsolationMVA3oldDMwoLT;
    result &= event->getByLabel( tTaubyTightCombinedIsolationDeltaBetaCorr, hTaubyTightCombinedIsolationDeltaBetaCorr );
    if ( hTaubyTightCombinedIsolationDeltaBetaCorr.isValid() ) TaubyTightCombinedIsolationDeltaBetaCorr = *hTaubyTightCombinedIsolationDeltaBetaCorr;
    result &= event->getByLabel( tTaubyTightCombinedIsolationDeltaBetaCorr3Hits, hTaubyTightCombinedIsolationDeltaBetaCorr3Hits );
    if ( hTaubyTightCombinedIsolationDeltaBetaCorr3Hits.isValid() ) TaubyTightCombinedIsolationDeltaBetaCorr3Hits = *hTaubyTightCombinedIsolationDeltaBetaCorr3Hits;
    result &= event->getByLabel( tTaubyTightIsolationMVA3newDMwLT, hTaubyTightIsolationMVA3newDMwLT );
    if ( hTaubyTightIsolationMVA3newDMwLT.isValid() ) TaubyTightIsolationMVA3newDMwLT = *hTaubyTightIsolationMVA3newDMwLT;
    result &= event->getByLabel( tTaubyTightIsolationMVA3newDMwoLT, hTaubyTightIsolationMVA3newDMwoLT );
    if ( hTaubyTightIsolationMVA3newDMwoLT.isValid() ) TaubyTightIsolationMVA3newDMwoLT = *hTaubyTightIsolationMVA3newDMwoLT;
    result &= event->getByLabel( tTaubyTightIsolationMVA3oldDMwLT, hTaubyTightIsolationMVA3oldDMwLT );
    if ( hTaubyTightIsolationMVA3oldDMwLT.isValid() ) TaubyTightIsolationMVA3oldDMwLT = *hTaubyTightIsolationMVA3oldDMwLT;
    result &= event->getByLabel( tTaubyTightIsolationMVA3oldDMwoLT, hTaubyTightIsolationMVA3oldDMwoLT );
    if ( hTaubyTightIsolationMVA3oldDMwoLT.isValid() ) TaubyTightIsolationMVA3oldDMwoLT = *hTaubyTightIsolationMVA3oldDMwoLT;
    result &= event->getByLabel( tTaubyVLooseCombinedIsolationDeltaBetaCorr, hTaubyVLooseCombinedIsolationDeltaBetaCorr );
    if ( hTaubyVLooseCombinedIsolationDeltaBetaCorr.isValid() ) TaubyVLooseCombinedIsolationDeltaBetaCorr = *hTaubyVLooseCombinedIsolationDeltaBetaCorr;
    result &= event->getByLabel( tTaubyVLooseIsolationMVA3newDMwLT, hTaubyVLooseIsolationMVA3newDMwLT );
    if ( hTaubyVLooseIsolationMVA3newDMwLT.isValid() ) TaubyVLooseIsolationMVA3newDMwLT = *hTaubyVLooseIsolationMVA3newDMwLT;
    result &= event->getByLabel( tTaubyVLooseIsolationMVA3newDMwoLT, hTaubyVLooseIsolationMVA3newDMwoLT );
    if ( hTaubyVLooseIsolationMVA3newDMwoLT.isValid() ) TaubyVLooseIsolationMVA3newDMwoLT = *hTaubyVLooseIsolationMVA3newDMwoLT;
    result &= event->getByLabel( tTaubyVLooseIsolationMVA3oldDMwLT, hTaubyVLooseIsolationMVA3oldDMwLT );
    if ( hTaubyVLooseIsolationMVA3oldDMwLT.isValid() ) TaubyVLooseIsolationMVA3oldDMwLT = *hTaubyVLooseIsolationMVA3oldDMwLT;
    result &= event->getByLabel( tTaubyVLooseIsolationMVA3oldDMwoLT, hTaubyVLooseIsolationMVA3oldDMwoLT );
    if ( hTaubyVLooseIsolationMVA3oldDMwoLT.isValid() ) TaubyVLooseIsolationMVA3oldDMwoLT = *hTaubyVLooseIsolationMVA3oldDMwoLT;
    result &= event->getByLabel( tTaubyVTightIsolationMVA3newDMwLT, hTaubyVTightIsolationMVA3newDMwLT );
    if ( hTaubyVTightIsolationMVA3newDMwLT.isValid() ) TaubyVTightIsolationMVA3newDMwLT = *hTaubyVTightIsolationMVA3newDMwLT;
    result &= event->getByLabel( tTaubyVTightIsolationMVA3newDMwoLT, hTaubyVTightIsolationMVA3newDMwoLT );
    if ( hTaubyVTightIsolationMVA3newDMwoLT.isValid() ) TaubyVTightIsolationMVA3newDMwoLT = *hTaubyVTightIsolationMVA3newDMwoLT;
    result &= event->getByLabel( tTaubyVTightIsolationMVA3oldDMwLT, hTaubyVTightIsolationMVA3oldDMwLT );
    if ( hTaubyVTightIsolationMVA3oldDMwLT.isValid() ) TaubyVTightIsolationMVA3oldDMwLT = *hTaubyVTightIsolationMVA3oldDMwLT;
    result &= event->getByLabel( tTaubyVTightIsolationMVA3oldDMwoLT, hTaubyVTightIsolationMVA3oldDMwoLT );
    if ( hTaubyVTightIsolationMVA3oldDMwoLT.isValid() ) TaubyVTightIsolationMVA3oldDMwoLT = *hTaubyVTightIsolationMVA3oldDMwoLT;
    result &= event->getByLabel( tTaubyVVTightIsolationMVA3newDMwLT, hTaubyVVTightIsolationMVA3newDMwLT );
    if ( hTaubyVVTightIsolationMVA3newDMwLT.isValid() ) TaubyVVTightIsolationMVA3newDMwLT = *hTaubyVVTightIsolationMVA3newDMwLT;
    result &= event->getByLabel( tTaubyVVTightIsolationMVA3newDMwoLT, hTaubyVVTightIsolationMVA3newDMwoLT );
    if ( hTaubyVVTightIsolationMVA3newDMwoLT.isValid() ) TaubyVVTightIsolationMVA3newDMwoLT = *hTaubyVVTightIsolationMVA3newDMwoLT;
    result &= event->getByLabel( tTaubyVVTightIsolationMVA3oldDMwLT, hTaubyVVTightIsolationMVA3oldDMwLT );
    if ( hTaubyVVTightIsolationMVA3oldDMwLT.isValid() ) TaubyVVTightIsolationMVA3oldDMwLT = *hTaubyVVTightIsolationMVA3oldDMwLT;
    result &= event->getByLabel( tTaubyVVTightIsolationMVA3oldDMwoLT, hTaubyVVTightIsolationMVA3oldDMwoLT );
    if ( hTaubyVVTightIsolationMVA3oldDMwoLT.isValid() ) TaubyVVTightIsolationMVA3oldDMwoLT = *hTaubyVVTightIsolationMVA3oldDMwoLT;
    result &= event->getByLabel( tTauchargedIsoPtSum, hTauchargedIsoPtSum );
    if ( hTauchargedIsoPtSum.isValid() ) TauchargedIsoPtSum = *hTauchargedIsoPtSum;
    ...
    result &= event->getByLabel( tTaudecayModeFindingNewDMs, hTaudecayModeFindingNewDMs );
    if ( hTaudecayModeFindingNewDMs.isValid() ) TaudecayModeFindingNewDMs = *hTaudecayModeFindingNewDMs;
    result &= event->getByLabel( tTaudecayModeFindingOldDMs, hTaudecayModeFindingOldDMs );
    if ( hTaudecayModeFindingOldDMs.isValid() ) TaudecayModeFindingOldDMs = *hTaudecayModeFindingOldDMs;
    result &= event->getByLabel( tTauneutralIsoPtSum, hTauneutralIsoPtSum );
    if ( hTauneutralIsoPtSum.isValid() ) TauneutralIsoPtSum = *hTauneutralIsoPtSum;
    result &= event->getByLabel( tTaupuCorrPtSum, hTaupuCorrPtSum );
    if ( hTaupuCorrPtSum.isValid() ) TaupuCorrPtSum = *hTaupuCorrPtSum;
...
void TreeClassBase::Init(void)
{
    ...
    tMaxPfCandEta              = edm::InputTag("analyze","MaxPfCandEta");
    ...
    tMinSCrawPt                = edm::InputTag("analyze","MinSCrawPt");
    ...
    tJBeta                     = edm::InputTag("analyze","JBeta");
    tJBetaSq                   = edm::InputTag("analyze","JBetaSq");
    ...
    tJPassPileupIDL0           = edm::InputTag("analyze","JPassPileupIDL0");
    tJPassPileupIDL1           = edm::InputTag("analyze","JPassPileupIDL1");
    tJPassPileupIDL2           = edm::InputTag("analyze","JPassPileupIDL2");
    tJPassPileupIDL3           = edm::InputTag("analyze","JPassPileupIDL3");
    tJPassPileupIDL4           = edm::InputTag("analyze","JPassPileupIDL4");
    tJPassPileupIDM0           = edm::InputTag("analyze","JPassPileupIDM0");
    tJPassPileupIDM1           = edm::InputTag("analyze","JPassPileupIDM1");
    tJPassPileupIDM2           = edm::InputTag("analyze","JPassPileupIDM2");
    tJPassPileupIDM3           = edm::InputTag("analyze","JPassPileupIDM3");
    tJPassPileupIDM4           = edm::InputTag("analyze","JPassPileupIDM4");
    tJPassPileupIDT0           = edm::InputTag("analyze","JPassPileupIDT0");
    tJPassPileupIDT1           = edm::InputTag("analyze","JPassPileupIDT1");
    tJPassPileupIDT2           = edm::InputTag("analyze","JPassPileupIDT2");
    tJPassPileupIDT3           = edm::InputTag("analyze","JPassPileupIDT3");
    tJPassPileupIDT4           = edm::InputTag("analyze","JPassPileupIDT4");
    ...
    tJQGTagLD                  = edm::InputTag("analyze","JQGTagLD");
    tJQGTagMLP                 = edm::InputTag("analyze","JQGTagMLP");
    tJRMSCand                  = edm::InputTag("analyze","JRMSCand");
    tJSmearedQGL               = edm::InputTag("analyze","JSmearedQGL");
    tJVrtxListStart            = edm::InputTag("analyze","JVrtxListStart");
    ...
    tPfCandBelongsToJet        = edm::InputTag("analyze","PfCandBelongsToJet");
    tPfCandEcalEnergy          = edm::InputTag("analyze","PfCandEcalEnergy");
    ...
    tPhoCiCPFIsoChargedDR03    = edm::InputTag("analyze","PhoCiCPFIsoChargedDR03");
    tPhoCiCPFIsoChargedDR04    = edm::InputTag("analyze","PhoCiCPFIsoChargedDR04");
    tPhoCiCPFIsoNeutralDR03    = edm::InputTag("analyze","PhoCiCPFIsoNeutralDR03");
    tPhoCiCPFIsoNeutralDR04    = edm::InputTag("analyze","PhoCiCPFIsoNeutralDR04");
    tPhoCiCPFIsoPhotonDR03     = edm::InputTag("analyze","PhoCiCPFIsoPhotonDR03");
    tPhoCiCPFIsoPhotonDR04     = edm::InputTag("analyze","PhoCiCPFIsoPhotonDR04");
    ...
    tPhoFootprintPfCands       = edm::InputTag("analyze","PhoFootprintPfCands");
    tPhoFootprintPfCandsListStart = edm::InputTag("analyze","PhoFootprintPfCandsListStart");
    ...
    tPhoIDMVA                  = edm::InputTag("analyze","PhoIDMVA");
    ...
    tPhoLambdaRatio            = edm::InputTag("analyze","PhoLambdaRatio");
    tPhoMCmatchexitcode        = edm::InputTag("analyze","PhoMCmatchexitcode");
    tPhoMCmatchindex           = edm::InputTag("analyze","PhoMCmatchindex");
    tPhoMatchedPFPhotonOrElectronCand = edm::InputTag("analyze","PhoMatchedPFPhotonOrElectronCand");
    ...
    tPhoRegrEnergy             = edm::InputTag("analyze","PhoRegrEnergy");
    tPhoRegrEnergyErr          = edm::InputTag("analyze","PhoRegrEnergyErr");
    tPhoS4OverS1               = edm::InputTag("analyze","PhoS4OverS1");
    tPhoS4Ratio                = edm::InputTag("analyze","PhoS4Ratio");
    tPhoSCEta                  = edm::InputTag("analyze","PhoSCEta");
    tPhoSCEtaWidth             = edm::InputTag("analyze","PhoSCEtaWidth");
    tPhoSCPhiWidth             = edm::InputTag("analyze","PhoSCPhiWidth");
    ...
    tPhoSCRemovalPFIsoChargedPrimVtx = edm::InputTag("analyze","PhoSCRemovalPFIsoChargedPrimVtx");
    tPhoSCRemovalPFIsoChargedPrimVtxRCone = edm::InputTag("analyze","PhoSCRemovalPFIsoChargedPrimVtxRCone");
    tPhoSCRemovalPFIsoChargedRCone = edm::InputTag("analyze","PhoSCRemovalPFIsoChargedRCone");
    tPhoSCRemovalPFIsoNeutral  = edm::InputTag("analyze","PhoSCRemovalPFIsoNeutral");
    tPhoSCRemovalPFIsoNeutralRCone = edm::InputTag("analyze","PhoSCRemovalPFIsoNeutralRCone");
    tPhoSCRemovalPFIsoPhoton   = edm::InputTag("analyze","PhoSCRemovalPFIsoPhoton");
    tPhoSCRemovalPFIsoPhotonRCone = edm::InputTag("analyze","PhoSCRemovalPFIsoPhotonRCone");
    tPhoSCRemovalRConeEta      = edm::InputTag("analyze","PhoSCRemovalRConeEta");
    tPhoSCRemovalRConePhi      = edm::InputTag("analyze","PhoSCRemovalRConePhi");
    ...
    tPhoSigmaIetaIphi          = edm::InputTag("analyze","PhoSigmaIetaIphi");
    tPhoSigmaIphiIphi          = edm::InputTag("analyze","PhoSigmaIphiIphi");
    tPhoSigmaRR                = edm::InputTag("analyze","PhoSigmaRR");
    tPhoVrtxListStart          = edm::InputTag("analyze","PhoVrtxListStart");
    ...
    tTauagainstElectronDeadECAL = edm::InputTag("analyze","TauagainstElectronDeadECAL");
    tTauagainstElectronLoose   = edm::InputTag("analyze","TauagainstElectronLoose");
    tTauagainstElectronLooseMVA5 = edm::InputTag("analyze","TauagainstElectronLooseMVA5");
    tTauagainstElectronMVA5category = edm::InputTag("analyze","TauagainstElectronMVA5category");
    tTauagainstElectronMVA5raw = edm::InputTag("analyze","TauagainstElectronMVA5raw");
    tTauagainstElectronMedium  = edm::InputTag("analyze","TauagainstElectronMedium");
    tTauagainstElectronMediumMVA5 = edm::InputTag("analyze","TauagainstElectronMediumMVA5");
    tTauagainstElectronTight   = edm::InputTag("analyze","TauagainstElectronTight");
    tTauagainstElectronTightMVA5 = edm::InputTag("analyze","TauagainstElectronTightMVA5");
    tTauagainstElectronVLooseMVA5 = edm::InputTag("analyze","TauagainstElectronVLooseMVA5");
    tTauagainstElectronVTightMVA5 = edm::InputTag("analyze","TauagainstElectronVTightMVA5");
    tTauagainstMuonLoose       = edm::InputTag("analyze","TauagainstMuonLoose");
    tTauagainstMuonLoose2      = edm::InputTag("analyze","TauagainstMuonLoose2");
    tTauagainstMuonLoose3      = edm::InputTag("analyze","TauagainstMuonLoose3");
    tTauagainstMuonLooseMVA    = edm::InputTag("analyze","TauagainstMuonLooseMVA");
    tTauagainstMuonMVAraw      = edm::InputTag("analyze","TauagainstMuonMVAraw");
    tTauagainstMuonMedium      = edm::InputTag("analyze","TauagainstMuonMedium");
    tTauagainstMuonMedium2     = edm::InputTag("analyze","TauagainstMuonMedium2");
    tTauagainstMuonMediumMVA   = edm::InputTag("analyze","TauagainstMuonMediumMVA");
    tTauagainstMuonTight       = edm::InputTag("analyze","TauagainstMuonTight");
    tTauagainstMuonTight2      = edm::InputTag("analyze","TauagainstMuonTight2");
    tTauagainstMuonTight3      = edm::InputTag("analyze","TauagainstMuonTight3");
    tTauagainstMuonTightMVA    = edm::InputTag("analyze","TauagainstMuonTightMVA");
    tTaubyCombinedIsolationDeltaBetaCorrRaw = edm::InputTag("analyze","TaubyCombinedIsolationDeltaBetaCorrRaw");
    tTaubyCombinedIsolationDeltaBetaCorrRaw3Hits = edm::InputTag("analyze","TaubyCombinedIsolationDeltaBetaCorrRaw3Hits");
    tTaubyIsolationMVA3newDMwLTraw = edm::InputTag("analyze","TaubyIsolationMVA3newDMwLTraw");
    tTaubyIsolationMVA3newDMwoLTraw = edm::InputTag("analyze","TaubyIsolationMVA3newDMwoLTraw");
    tTaubyIsolationMVA3oldDMwLTraw = edm::InputTag("analyze","TaubyIsolationMVA3oldDMwLTraw");
    tTaubyIsolationMVA3oldDMwoLTraw = edm::InputTag("analyze","TaubyIsolationMVA3oldDMwoLTraw");
    tTaubyLooseCombinedIsolationDeltaBetaCorr = edm::InputTag("analyze","TaubyLooseCombinedIsolationDeltaBetaCorr");
    tTaubyLooseCombinedIsolationDeltaBetaCorr3Hits = edm::InputTag("analyze","TaubyLooseCombinedIsolationDeltaBetaCorr3Hits");
    tTaubyLooseIsolation       = edm::InputTag("analyze","TaubyLooseIsolation");
    tTaubyLooseIsolationMVA3newDMwLT = edm::InputTag("analyze","TaubyLooseIsolationMVA3newDMwLT");
    tTaubyLooseIsolationMVA3newDMwoLT = edm::InputTag("analyze","TaubyLooseIsolationMVA3newDMwoLT");
    tTaubyLooseIsolationMVA3oldDMwLT = edm::InputTag("analyze","TaubyLooseIsolationMVA3oldDMwLT");
    tTaubyLooseIsolationMVA3oldDMwoLT = edm::InputTag("analyze","TaubyLooseIsolationMVA3oldDMwoLT");
    tTaubyMediumCombinedIsolationDeltaBetaCorr = edm::InputTag("analyze","TaubyMediumCombinedIsolationDeltaBetaCorr");
    tTaubyMediumCombinedIsolationDeltaBetaCorr3Hits = edm::InputTag("analyze","TaubyMediumCombinedIsolationDeltaBetaCorr3Hits");
    tTaubyMediumIsolationMVA3newDMwLT = edm::InputTag("analyze","TaubyMediumIsolationMVA3newDMwLT");
    tTaubyMediumIsolationMVA3newDMwoLT = edm::InputTag("analyze","TaubyMediumIsolationMVA3newDMwoLT");
    tTaubyMediumIsolationMVA3oldDMwLT = edm::InputTag("analyze","TaubyMediumIsolationMVA3oldDMwLT");
    tTaubyMediumIsolationMVA3oldDMwoLT = edm::InputTag("analyze","TaubyMediumIsolationMVA3oldDMwoLT");
    tTaubyTightCombinedIsolationDeltaBetaCorr = edm::InputTag("analyze","TaubyTightCombinedIsolationDeltaBetaCorr");
    tTaubyTightCombinedIsolationDeltaBetaCorr3Hits = edm::InputTag("analyze","TaubyTightCombinedIsolationDeltaBetaCorr3Hits");
    tTaubyTightIsolationMVA3newDMwLT = edm::InputTag("analyze","TaubyTightIsolationMVA3newDMwLT");
    tTaubyTightIsolationMVA3newDMwoLT = edm::InputTag("analyze","TaubyTightIsolationMVA3newDMwoLT");
    tTaubyTightIsolationMVA3oldDMwLT = edm::InputTag("analyze","TaubyTightIsolationMVA3oldDMwLT");
    tTaubyTightIsolationMVA3oldDMwoLT = edm::InputTag("analyze","TaubyTightIsolationMVA3oldDMwoLT");
    tTaubyVLooseCombinedIsolationDeltaBetaCorr = edm::InputTag("analyze","TaubyVLooseCombinedIsolationDeltaBetaCorr");
    tTaubyVLooseIsolationMVA3newDMwLT = edm::InputTag("analyze","TaubyVLooseIsolationMVA3newDMwLT");
    tTaubyVLooseIsolationMVA3newDMwoLT = edm::InputTag("analyze","TaubyVLooseIsolationMVA3newDMwoLT");
    tTaubyVLooseIsolationMVA3oldDMwLT = edm::InputTag("analyze","TaubyVLooseIsolationMVA3oldDMwLT");
    tTaubyVLooseIsolationMVA3oldDMwoLT = edm::InputTag("analyze","TaubyVLooseIsolationMVA3oldDMwoLT");
    tTaubyVTightIsolationMVA3newDMwLT = edm::InputTag("analyze","TaubyVTightIsolationMVA3newDMwLT");
    tTaubyVTightIsolationMVA3newDMwoLT = edm::InputTag("analyze","TaubyVTightIsolationMVA3newDMwoLT");
    tTaubyVTightIsolationMVA3oldDMwLT = edm::InputTag("analyze","TaubyVTightIsolationMVA3oldDMwLT");
    tTaubyVTightIsolationMVA3oldDMwoLT = edm::InputTag("analyze","TaubyVTightIsolationMVA3oldDMwoLT");
    tTaubyVVTightIsolationMVA3newDMwLT = edm::InputTag("analyze","TaubyVVTightIsolationMVA3newDMwLT");
    tTaubyVVTightIsolationMVA3newDMwoLT = edm::InputTag("analyze","TaubyVVTightIsolationMVA3newDMwoLT");
    tTaubyVVTightIsolationMVA3oldDMwLT = edm::InputTag("analyze","TaubyVVTightIsolationMVA3oldDMwLT");
    tTaubyVVTightIsolationMVA3oldDMwoLT = edm::InputTag("analyze","TaubyVVTightIsolationMVA3oldDMwoLT");
    tTauchargedIsoPtSum        = edm::InputTag("analyze","TauchargedIsoPtSum");
    tTaudecayModeFinding       = edm::InputTag("analyze","TaudecayModeFinding");
    tTaudecayModeFindingNewDMs = edm::InputTag("analyze","TaudecayModeFindingNewDMs");
    tTaudecayModeFindingOldDMs = edm::InputTag("analyze","TaudecayModeFindingOldDMs");
    tTauneutralIsoPtSum        = edm::InputTag("analyze","TauneutralIsoPtSum");
    tTaupuCorrPtSum            = edm::InputTag("analyze","TaupuCorrPtSum");
