...
void makeCardTauTau1(double N, double S, double dS, string sOut) {
    ...
    double dTauTau1BMC = 0.28;//its relative systematic uncer
    ...
    double TauTauBW =  0.72;     //WJets  0.721364 +- 0.11128 +- 0.112084 +- 0.562293 
    double dTauTauBW = 0.81;//WJets (0.11 @ 0.11 @ 0.56)/0.72
...
void makeCardTauTau2(double N, double S, double dS, string sOut) {
    ...
    double dTauTau2BMC = 0.28;//its relative systematic uncer
    ...
    double TauTauBW = 2.58; //Wjets 2.58335 +- 0.350643 +- 1.04287 +- 0.68818
     double dTauTauBW = 0.50;//Wjets (0.35 @ 1.04 @ 0.69)/2.58
...
run_setUpperLimitCorrectCorrelation3Jan18() {

    std::vector< TString > sin;
    int argc = gApplication->Argc();
    for (int i = 0; i < argc; i++) {
        TString argvi = gApplication->Argv(i);
	if (argvi.Contains("run_setUpperLimitCorrectCorrelation3Jan18.C"))
