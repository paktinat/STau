...
TH2D* getXsecUp(TH2D* hRatio, TH2D* hXsec) {
    ...
    hXsecUp->GetXaxis()->SetRangeUser(100, 250);
    hXsecUp->GetYaxis()->SetRangeUser(0, 150);
    hXsecUp->GetZaxis()->SetRangeUser(0.0001, 100);

    hXsecUp->GetXaxis()->SetTitle("m_{#tilde{#tau}} [GeV/c]");
...
//     hXsecUp->GetZaxis()->SetRangeUser(0.1, 0.6);
  ...
  //   TH2D* hXsec = (TH2D*) TFile::Open("referenceXSecs.root")->Get("C1C1_8TeV_NLONLL_LSP");
    ...
    TH2D* hXsec = (TH2D*) TFile::Open("referenceXSecs.root")->Get("StSt_8TeV_NLONLL_LSP");
