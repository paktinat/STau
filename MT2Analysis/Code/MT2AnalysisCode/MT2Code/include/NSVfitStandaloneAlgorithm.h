...
//added by Hamed to make the code compile !
...
struct A{
  typedef edm::Hash<1> key_type ;
  typedef edm::ParameterSet value_type;
  typedef edm::pset::ProcessParameterSetIDCache extra_type;
};
DEFINE_THREAD_SAFE_REGISTRY_INSTANCE(A)
...
//end of the part added by Hamed
