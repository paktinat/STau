...
public:
	...
	TGraphAsymmErrors* plotSig(TH1 *hSgn, TH1 *hBkg, TString xtitle = "MET", TString cutType = "lowerCut", int type = 0, double sys = 0.10); // type: 0: s/sqrt(b), 1: s/sqrt(s+b), 2:s/b, 3: signal strength 
  ...
  void getGenEfficiencies(unsigned int nEvts);
  bool wayToSort(TLorentzVector l1, TLorentzVector l2); 
