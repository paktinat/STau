...
*/
  ...
  //myChannelCuts.push_back("(misc.ProcessID!=10 || (abs(Susy.MassGlu - 180.0) <= 10.0 && abs(Susy.MassLSP - 60) <= 10.0))");//0.119//0.0111
 // myChannelCuts.push_back("(misc.ProcessID!=10 || (abs(Susy.MassGlu - 390.0) <= 10.0 && abs(Susy.MassLSP - 10) <= 10.0))"); //0.227//0.0343
  myChannelCuts.push_back("(misc.ProcessID!=10 || (Susy.MassGlu  >= 380.0 && Susy.MassGlu  < 400.0 && Susy.MassLSP < 20.0))"); //0.227//0.0343
  ...
  //myChannelCuts.push_back("(misc.ProcessID!=10 || (abs(Susy.MassGlu - 240.0) <= 10.0 && abs(Susy.MassLSP - 40) <= 10.0))");//0.14986//0.01414
...
//WJets   
  ...
  myChannelCuts.push_back("abs(muTau[0].chargeSum) == 2");
...
//      myChannelCuts.push_back(" tau[muTau[0].tau0Ind].MT < 100 ");//tauMT
...
//   tA->makePlot("muTau[0].MT2",     cuts,    -10,  0 , -10 ,   trigger , "MT2"            , 12, 0, 120,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 2);
  tA->makePlot("muo[muTau[0].mu0Ind].MT + tau[muTau[0].tau0Ind].MT",     cuts,    -10,  0 , -10 ,   trigger , "SumMT"            ,35, 0, 350,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
  ...
  //tA->makePlot("muTau[0].lv.M()",     cuts,    -10,  0 , -10 ,   trigger , "M"            , 60, 15, 315,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 2);
  //No peak //SumMT > 300 
  ...
  //tA->makePlot("tau[muTau[0].tau0Ind].lv.Pt()",     cuts,    -10,  0 , -10 ,   trigger , "tauPt"            , 10, 20, 120,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 3);
  ...
  //tA->makePlot("muo[muTau[0].mu0Ind].lv.Pt()",     cuts,    -10,  0 , -10 ,   trigger , "muPt"            ,10, 20, 120,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 3);
  ...
  //<0 13.3 40-90
  //  tA->makePlot("muo[muTau[0].mu0Ind].MT - tau[muTau[0].tau0Ind].MT",     cuts,    -10,  0 , -10 ,   trigger , "muMT - tauMT"            ,10, -250, 250,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
  //tA->makePlot("JZBDPhi()",     cuts,    -10,  0 , -10 ,   trigger , "JZBDPhi"            , 16, 0, 3.2,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 2);
  // tA->makePlot("muTauDR()",     cuts,    -10,  0 , -10 ,   trigger , "muTauDR"            , 10, 0, 5.0,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 3);
  ...
  //>250 1.76 tA->makePlot("((muo[muTau[0].mu0Ind].MT + tau[muTau[0].tau0Ind].MT) - muTau[0].MT2) ",     cuts,    -10,  0 , -10 ,   trigger , "SumMT - MT2"            , 10, 100, 400,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 3);
  //> 180 1.99//minMetJetDPhiPt40 > 1
  // no peak //SumMT > 300
  //tA->makePlot("muo[muTau[0].mu0Ind].MT",     cuts,    -10,  0 , -10 ,   trigger , "muMT"            ,20, 0, 200,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
  //> 1 2.0 
  //> 1 1.5  //SumMT > 300
  //>1 13.5 40-90
  ...
  //  tA->makePlot("minMetTauDPhiMuTau()",     cuts,    -10,  0 , -10 ,   trigger , "minMetTauDPhiPt"            ,17, 0, 3.4,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 3);
  //>340 1.5  
  //>325 1.25//minMetJetDPhiPt40 > 1  
  //tA->makePlot("muTau[0].DPhi",     cuts,    -10,  0 , -10 ,   trigger , "muTauDPhi"            , 16, 0, 3.2,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 2);
  ...
  //>110 1.8//SumMT > 300
  //no peak 40-90 
  //tA->makePlot("misc.MET",     cuts,    -10,  0 , -10 ,   trigger , "pfMET"            ,33, 30, 360,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
  //tA->makePlot("tau[muTau[0].tau0Ind].MT",     cuts,    -10,  0 , -10 ,   trigger , "tauMT"            ,60, 0, 300,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
  // tA->makePlot("tau[muTau[0].tau0Ind].lv.Eta()",     cuts,    -10,  0 , -10 ,   trigger , "tauEta"            ,20, -2.5, 2.5,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
  ...
  //tA->makePlot("NBJetsCSVL",     cuts,    -10, -10 , -10 ,   trigger , "NBJetsCSVL"            ,6, 0, 6,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);      
...
//   tA->makePlot("LepMT()",     cuts,    -10, 0 , -10 ,   trigger , "MassMuMu"            ,101, -10, 1000,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
  ...
  //tA->muTauAnalysis(cuts, trigger, 100000, "Loose");
  //tA->TauFakeRate(cuts, trigger, 10000000000, "PtEta_MuTauTight_Over_Loose_pfOnly_WJets_OppSign_ExtraLepVeto_MET_NBJets_Weighted");
