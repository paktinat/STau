...
inline Float_t getBTagEventWeightErrorTotal(float &werr, vector<float> jetEff, vector<float> jetEffErr, vector<float> jetSF, vector<float> jetSFBCdown, vector<float> jetSFBCup, vector<float> jetSFlightdown, vector<float> jetSFlightup, vector<float> jetSFFSdown, vector<float> jetSFFSup, bool fastsim, int nBTags){
	float statefferr = 0;
//	float weight = getBTagEventWeightError(statefferr, jetEff, jetEffErr, jetSF, nBTags);
	...
	float staterrup         = getBTagEventWeight(jetEffup, jetSF, nBTags);
	float staterrdown       = getBTagEventWeight(jetEffdown, jetSF, nBTags);
	...
	if(fastsim) FSerrorup   = fabs(weight-getBTagEventWeight(jetEff, jetSFFSup, nBTags));//fastsim error
	if(fastsim) FSerrordown = fabs(weight-getBTagEventWeight(jetEff, jetSFFSdown, nBTags));//fastsim error
...
//uses getBTagEventWeightError and getBTagEventWeight from above
inline Float_t getBTagEventWeightTwoSidedErrorTotal(float &werrup, float &werrdown, vector<float> jetEff, vector<float> jetEffErr, vector<float> jetSF, vector<float> jetSFBCdown, vector<float> jetSFBCup, vector<float> jetSFlightdown, vector<float> jetSFlightup, vector<float> jetSFFSdown, vector<float> jetSFFSup, bool fastsim, int nBTags){
	float statefferr = 0;
//	float weight = getBTagEventWeightError(statefferr, jetEff, jetEffErr, jetSF, nBTags);
