...
*/
 ...
 // myChannelCuts.push_back("(misc.ProcessID!=10 || (abs(Susy.MassGlu - 390.0) <= 10.0 && abs(Susy.MassLSP - 10) <= 10.0))"); //0.227//0.0343
  ...
  myChannelCuts.push_back("(misc.ProcessID!=10 || (  (Susy.MassLSP < 150) && (Susy.MassGlu < 250) ))"); 
  ...
  //Different Bins of LIP
  //Bin1 
  myChannelCuts.push_back("((misc.MET + tau[muTau[0].tau0Ind].lv.Pt()) > 130)");
  myChannelCuts.push_back("(muTau[0].DPhi >   2.)");
  myChannelCuts.push_back("(abs(tau[muTau[0].tau0Ind].lv.Eta()) < 1.4722 )");
  myChannelCuts.push_back("((muTau[0].lv.M() - 61) < 120)");
  myChannelCuts.push_back("(muTau[0].MT2 < 35)");


//   //Bin2 
//   myChannelCuts.push_back("((muo[muTau[0].mu0Ind].MT + tau[muTau[0].tau0Ind].MT) > 260 )");//SumMT
//   myChannelCuts.push_back("(abs(muo[muTau[0].mu0Ind].lv.Eta()) < 1.4722 )");
//   myChannelCuts.push_back("(tau[muTau[0].tau0Ind].MT > 60)");
//   myChannelCuts.push_back("((misc.MET + muo[muTau[0].mu0Ind].lv.Pt()) > 140)");



//   //Bin2 
//   myChannelCuts.push_back("((muo[muTau[0].mu0Ind].MT + tau[muTau[0].tau0Ind].MT) > 285 )");//SumMT
//   myChannelCuts.push_back("(tau[muTau[0].tau0Ind].MT > 60)");
//   myChannelCuts.push_back("(muo[muTau[0].mu0Ind].MT > 90)");
//   myChannelCuts.push_back("((misc.MET + tau[muTau[0].tau0Ind].lv.Pt()) > 160)");
