...
//   tA->makePlot("muTau[0].MT2",     cuts,    -10,  0 , -10 ,   trigger , "MT2"            , 24, 0, 120,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 2);
  ...
  //  tA->makePlot("muTau[0].lv.Pt()",     cuts,    -10,  0 , -10 ,   trigger , "M"            , 300, 0, 300,          false,        true ,  true,   true,  true,  true, 1,true, false, "C", 2);
  //No peak //SumMT > 300 
  ...
  tA->makePlot("muo[muTau[0].mu0Ind].MT + tau[muTau[0].tau0Ind].MT",     cuts,    -10,  0 , -10 ,   trigger , "SumMT"            ,600, 0, 600,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
  ...
  //tA->makePlot("tau[muTau[0].tau0Ind].MT",     cuts,    -10,  0 , -10 ,   trigger , "tauMT"            ,20, 0, 200,          false,        true ,  true,   true,  true,  true, 1, true, false, "C", 2);
